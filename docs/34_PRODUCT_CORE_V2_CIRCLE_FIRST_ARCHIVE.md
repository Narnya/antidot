# 🗄️ ARCHIVED — Product Core v2 (Circle-First) — Antidot

> **Status:** ❌ **ARCHIVED / SUPERSEDED. NOT the source of truth.**
> This is the **verbatim, preserved** text of the **circle-first Product Core v2** that governed the product from **2026-05-29 to 2026-07-07**. It is kept here as a **historical record** — «мы были когда-то circle-first». Do **not** implement against it.
> **Current source of truth:** [`/docs/00_PRODUCT_CORE.md`](00_PRODUCT_CORE.md) (Product Core **v3 — activity-first**).
> **Why it was superseded:** the circle-first model was, in practice, at war with the founder's actual goal (знакомства через активность). See [`/docs/30_PRODUCT_DIRECTION_ACTIVITY_FIRST.md`](30_PRODUCT_DIRECTION_ACTIVITY_FIRST.md) §0.
> **Lineage:** event-first v0.1 → **circle-first v2 (this doc)** → activity-first v3. The circle-first re-core proposals live in [`/docs/22`](22_PRODUCT_CORE_RECORE_PROPOSAL.md), [`/docs/24`](24_PRODUCT_CORE_V2_CIRCLES_PROPOSAL.md), [`/docs/25`](25_PRODUCT_CORE_MANIFESTO.md), [`/docs/26`](26_PRODUCT_CORE_V2_DECISION.md).
>
> **Still binding from this doc (carried forward into v3):** the Антидот naming block (§Naming), the technical stack (§36), and the **safety spine** — the 16 invariants, except the hard rule «no dating mechanics», which v3 **recalibrated** (romance may emerge as a background outcome; no swipe / no people-browsing / no cold DMs). See [`/docs/30`](30_PRODUCT_DIRECTION_ACTIVITY_FIRST.md) §4.
>
> _--- everything below is the original circle-first text, preserved unchanged ---_
